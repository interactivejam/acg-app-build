    ...
    <section>
      <div class="find_sec">
        <div class="container">
          ...
          <!-- {{story.content.Body[1].reference}} -->
      ...
      <component v-if="story.content.component" :key="story.content._uid" :blok="story.content" :category_reference="story.content.Body[0].reference" :faq_reference="story.content.Body[1].reference" :slug="story.full_slug" :is="story.content.component"></component>
    </section>
  </div>
</template>
